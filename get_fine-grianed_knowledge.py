...
client_gpt = OpenAI(
    api_key="sk-pPfiuTnHPi20By5o82Cb48BbE0Bb4113817350C713F9Cb65" #"https://uiuiapi.com/v1
    # api_key ="sk-YmMgAlBKJ4m8ypsz517a963258Af4c0c963c4fBe128735Ea"
)

client_glm = ZhipuAI(api_key="5857ea1a755b3bed50800769b3dd5a60.SZIu1RKDLYzcHyWU")
#Person
